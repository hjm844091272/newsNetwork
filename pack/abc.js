...
// 定义混合类，实现ajax方法
var Util = exports.Util = function (_Component) {
   ...
   **/
		...
		key: 'ObjectToQuery',
		value: function ObjectToQuery(obj) {
			var result = '';
			// 解析obj
			for (var i in obj) {
...
// 引入render和路由
(0, _reactDom.render)(_router.routes, document.getElementById('ickt'));
...
*/
var aa=__webpack_require__(0),l=__webpack_require__(27),B=__webpack_require__(28),C=__webpack_require__(9),ba=__webpack_require__(29),da=__webpack_require__(30),ea=__webpack_require__(31),fa=__webpack_require__(32),ia=__webpack_require__(33),D=__webpack_require__(34);
...
var m=__webpack_require__(23),n=__webpack_require__(24),p=__webpack_require__(12),q="function"===typeof Symbol&&Symbol["for"],r=q?Symbol["for"]("react.element"):60103,t=q?Symbol["for"]("react.call"):60104,u=q?Symbol["for"]("react.return"):60105,v=q?Symbol["for"]("react.portal"):60106,w=q?Symbol["for"]("react.fragment"):60107,x="function"===typeof Symbol&&Symbol.iterator;
...
var _comments = __webpack_require__(100);

var _detail = __webpack_require__(103);

var _app = __webpack_require__(106);

var appLess = _interopRequireWildcard(_app);
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					null,
					_react2.default.createElement(_reactRouterDom.Route, { path: '/list', component: _list.List }),
					_react2.default.createElement(_reactRouterDom.Route, { path: '/detail/:id', component: _detail.Detail }),
					_react2.default.createElement(_reactRouterDom.Route, { path: '/comments/:id', component: _comments.Comments }),
...
var headerLess = _interopRequireWildcard(_header);
...
var Header = exports.Header = function (_Component) {
	...
	_createClass(Header, [{
		...
		value: function childMethod() {
			// console.log('child',this, arguments)
			// // 父组件方法
			// // this.props.method.call(this)
			// this.props.method()
			// 返回上一个状态页面
			history.go(-1);
		}
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					{ className: 'go-back', onClick: this.childMethod.bind(this) },
					'<'
				),
				_react2.default.createElement(
					'div',
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../../../../../AppData/Roaming/npm/node_modules/css-loader/index.js!../../../../../../../AppData/Roaming/npm/node_modules/less-loader/dist/cjs.js!./header.less", function() {
			var newContent = require("!!../../../../../../../AppData/Roaming/npm/node_modules/css-loader/index.js!../../../../../../../AppData/Roaming/npm/node_modules/less-loader/dist/cjs.js!./header.less");
...
var listLess = _interopRequireWildcard(_list);
...
// 三个页面组件
// 使用util的方法，要继承Util
var List = exports.List = function (_Util) {
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../../../../../AppData/Roaming/npm/node_modules/css-loader/index.js!../../../../../../../AppData/Roaming/npm/node_modules/less-loader/dist/cjs.js!./list.less", function() {
			var newContent = require("!!../../../../../../../AppData/Roaming/npm/node_modules/css-loader/index.js!../../../../../../../AppData/Roaming/npm/node_modules/less-loader/dist/cjs.js!./list.less");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
var commentsLess = _interopRequireWildcard(_comments);
...
var Comments = exports.Comments = function (_Util) {
	_inherits(Comments, _Util);
	...
	_createClass(Comments, [{
		...
		value: function submitData() {
			...
			if (/\S+/.test(value)) {
				...
				var userData = {
					...
					// 合法，继续进行
				};this.ajax('data/addComment.json' + this.ObjectToQuery(userData), function (res) {
					// 请求成功
					if (res && res.errno === 0) {
						// 4 发送请求，通知服务器
		...
		value: function render() {
			return React.createElement(
				...
				React.createElement(
					'div',
					{ className: 'box' },
					React.createElement('textarea', { placeholder: '\u6587\u660E\u4E0A\u7F51\uFF0C\u7406\u6027\u53D1\u8A00\uFF01', ref: 'userInput' }),
					React.createElement(
						'span',
						{ className: 'btn', onClick: this.submitData.bind(this) },
						'\u63D0\u4EA4'
					)
				),
				React.createElement(
		...
		value: function componentDidMount() {
			...
			// 发送请求
			this.ajax('data/comment.json?id=' + this.props.match.params.id, function (res) {
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../../../../../AppData/Roaming/npm/node_modules/css-loader/index.js!../../../../../../../AppData/Roaming/npm/node_modules/less-loader/dist/cjs.js!./comments.less", function() {
			var newContent = require("!!../../../../../../../AppData/Roaming/npm/node_modules/css-loader/index.js!../../../../../../../AppData/Roaming/npm/node_modules/less-loader/dist/cjs.js!./comments.less");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
var detailLess = _interopRequireWildcard(_detail);
...
var Detail = exports.Detail = function (_Util) {
	_inherits(Detail, _Util);
	...
	_createClass(Detail, [{
		...
		value: function render() {
			...
			return React.createElement(
				...
				React.createElement("p", { className: "content", dangerouslySetInnerHTML: {
						__html: data.content
					} }),
				React.createElement(
					_reactRouterDom.Link,
					{ to: '/comments/' + data.id, className: "btn" },
					"\u67E5\u770B\u66F4\u591A\u8BC4\u8BBA"
				)
			);
		}
		...
		value: function componentDidMount() {
			...
			// 拉取数据
			this.ajax('data/detail.json?id=' + this.props.match.params.id, function (res) {
				// 如果请求成功，存储数据
				if (res && res.errno === 0) {
					// 更新状态
					_this2.setState({
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../../../../../AppData/Roaming/npm/node_modules/css-loader/index.js!../../../../../../../AppData/Roaming/npm/node_modules/less-loader/dist/cjs.js!./detail.less", function() {
			var newContent = require("!!../../../../../../../AppData/Roaming/npm/node_modules/css-loader/index.js!../../../../../../../AppData/Roaming/npm/node_modules/less-loader/dist/cjs.js!./detail.less");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../../../../AppData/Roaming/npm/node_modules/css-loader/index.js!../../../../../../AppData/Roaming/npm/node_modules/less-loader/dist/cjs.js!./app.less", function() {
			var newContent = require("!!../../../../../../AppData/Roaming/npm/node_modules/css-loader/index.js!../../../../../../AppData/Roaming/npm/node_modules/less-loader/dist/cjs.js!./app.less");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
